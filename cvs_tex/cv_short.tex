...
%         % \item Made the first draft of course slides for OCW
%         % \item Graded final projects
%         % \item Provided extra support for office hours when needed
% 	\end{itemize}
...
% \begin{body}
% 	\vspace{14pt}
% 	\emph{\textbf{Coding:}}{} Python, Matlab, OCaml, Java, Go, Javascript, Maude, Coq\\
% 	\smallskip
% 	\emph{\textbf{Tools:}}{}  Pytorch, Tensorflow, Unix, vim, git\\
% 	\smallskip
...
\end{itemize}
 ...
 %    	\item Mentoring five undergraduate students on two projects: meta-learning and neural theorem proving
	% \end{itemize}
	% \vspace{5 pt}
