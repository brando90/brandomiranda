...
\begin{body}
	...
	\begin{itemize} \itemsep -2pt  % reduce space between items
		\item Ph.D. research with Prof. Sanmi Koyejo on \textbf{AI for formal mathematics and Lean 4}: benchmarks, tooling, and training methods for autoformalization, theorem proving, and end-to-end formal verification of AI-generated code. Adjacent threads on data-centric ML and frontier-model evaluation inform dataset and benchmark design.
		\item Lead/co-lead on four Lean 4 artifacts: \textit{Putnam-AXIOM} (functional/static Putnam-level math reasoning benchmark, ICML 2025), \textit{VeriBench} (end-to-end Lean 4 formal verification benchmark for AI code generation, 2nd AI for Math Workshop @ ICML 2025), \textit{Pantograph} (machine-to-machine interface for Lean 4 used by autoformalization and proof-search pipelines, TACAS 2025), and an autoformalization benchmark for Lean 4 (ICLR 2024 Tiny Papers Track).
		\item Founding member of \href{https://aiforlean.org/}{Stanford AI for Lean}, a Stanford research community advancing AI for Lean theorem proving and autoformalization of mathematics.
		\item Published award-winning work challenging prevailing notions of ``emergent abilities'' in large language models (NeurIPS Outstanding Paper Award 2023); the data-centric ML thread (\textit{Beyond Scale} diversity coefficient; contamination quantification) directly informs Lean autoformalization corpus design and benchmark integrity.
	...
	\begin{itemize} \itemsep -2pt
		\item Trained and evaluated LLMs for the \textbf{Lean 4} Proof Assistant and Programming Language for end-to-end formal verification --- aligned with AWS automated reasoning initiatives.
	\end{itemize}
	\vspace{5 pt}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item \textbf{Lean 4 frontier model:} co-built \textit{Morph Prover v0-7B}, the first openly released frontier model trained for the Lean 4 formal verification language.
		\item \textbf{Lean retrieval:} led the embedding system behind \textit{Moogle.ai} for verified Lean-code search, enabling premise selection and proof retrieval workflows.
	\end{itemize}
	\vspace{5 pt}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item Consulted on AI agent-based systems to transform sales performance.
...
\begin{body}
    ...
    \vspace{10pt}
    \href{https://arxiv.org/abs/2601.04301}
    ...
    \vspace{10pt}
    \href{https://arxiv.org/abs/2501.08506}
    ...
    \\
    (Preprint, arXiv 2024) --- gzip-based data-selection framework demonstrated on \textbf{autoformalization} (Lean) and code-generation pipelines; outperforms DSIR and D4 baselines by significant margins.
