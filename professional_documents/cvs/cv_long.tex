...
\begin{body}
	...
	Advisor: Prof. Sanmi Koyejo, Stanford Trustworthy AI Research Group.\\
...
\begin{body}
	...
	\emph{Ph.D. Student in Computer Science (Professor Sanmi Koyejo)}\\
	\vspace{8pt}
	...
	\emph{Graduate Student (Professor Sanmi Koyejo)}\\
	\vspace{8pt}
	...
	\emph{Research Assistant (Professor Tomaso Poggio)}\\
	\vspace{8pt}
...
\begin{body}
    ...
    \vspace{8pt}
    \emph{Google Scholar metrics: 3,014+ citations | h-index: 17 | i10-index: 22.}\\
    \emph{Publications below are split into \textbf{Refereed Publications} (peer-reviewed at conferences, journals, or refereed workshops) and \textbf{Preprints and Technical Reports} (arXiv-only or not-yet-refereed). Each paper appears exactly once.}
    ...
    \\
    (\textbf{ICLR 2026 Workshop on Logical Reasoning of Large Language Models})
    ...
    \\
    (\textbf{ICLR 2026 Workshop on Lifelong Agents: Learning, Aligning, Evolving})
    ...
    \\
    (\textbf{5th Workshop on Mathematical Reasoning and AI at NeurIPS 2025}) --- \textbf{Lean 4} formal theorem proving benchmark.
    ...
    \\
    (\textbf{ICLR 2024} \& NeurIPS Red Teaming GenAI Workshop Contributed Talk 2024)
    ...
    \\
    (The Second Tiny Papers Track at ICLR 2024) --- \textbf{Lean} autoformalization data-quality study.
    ...
    \\
    (Preprint 2025, arXiv:2502.15795) --- \textbf{Lean 4} autoformalization data-quality study.
    ...
    \\
    (Preprint, arXiv 2024) --- gzip-based data-selection framework demonstrated on \textbf{autoformalization} (Lean) and code-generation pipelines.

    \vspace{10pt}
    \pubitem {J. Rotella, Z. Qin, A. Z. H. Yang, B. Miranda, M. E. A. Seddik, J. Zuo, H. Hacid, et al.,
    Synthetic Theorem Generation in Lean.}
    \\
    (Preprint 2024) --- \textbf{Lean 4} synthetic theorem-proof data generation.
...
\begin{itemize} \itemsep -2pt
    ...
    \item \textbf{ICML Outstanding Paper Award, TiFA Workshop} (July 2024) --- for ``Why Has Predicting Downstream Capabilities of Frontier AI Models with Scale Remained Elusive?'' (Schaeffer, Schoelkopf, Miranda, et al.).
