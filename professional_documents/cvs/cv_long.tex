...
\begin{body}
    ...
    \\
    (ICLR Workshop on Logical Reasoning of Large Language Models. 2026)
    ...
    \\
    (ICLR Workshop on Lifelong Agents: Learning, Aligning, Evolving. 2026)
    ...
    \\
    (International Conference on Machine Learning (ICML). 2025 \& ICML Workshop on Trustworthy Multi-modal Foundation Models and AI Agents (TiFA) --- Outstanding Paper Award. 2024)
    ...
    \\
    (International Conference on Machine Learning (ICML). 2025 \& NeurIPS Workshop on Mathematics and AI (MATH-AI). 2024)
    ...
    \\
    (International Conference on Tools and Algorithms for the Construction and Analysis of Systems (TACAS). 2025 - International Conference on Tools and Algorithms for the Construction and Analysis of Systems)
    ...
    \\
    (5th NeurIPS Workshop on Mathematical Reasoning and AI. 2025)
    ...
    \\
    (International Conference on Learning Representations (ICLR). 2024 \& NeurIPS Workshop on Red Teaming Generative AI, Contributed Talk. 2024)
    ...
    \\
    (NeurIPS Workshop on Unifying Representations in Neural Models (UniReps), 2nd Edition. 2024)
    ...
    \\
    (ICLR Tiny Papers Track, Second Edition. 2024)
    ...
    \\
    (ICML Workshop on Data-Centric Machine Learning \& ICML Workshop on Deployable Generative AI. 2023) (*equal contribution)
