...
\begin{body}
	...
	\begin{itemize} \itemsep -2pt
		\item Ph.D. with Prof. Sanmi Koyejo on \textbf{AI for formal mathematics and Lean 4}; lead/co-lead on \textit{Putnam-AXIOM} (ICML 2025), \textit{VeriBench} (ICML AI4Math 2025), \textit{Pantograph} (TACAS 2025), and an autoformalization benchmark (ICLR 2024 Tiny Papers); adjacent data-centric ML work on the NeurIPS Outstanding ``emergent-abilities mirage'' and the \textit{Beyond Scale} diversity coefficient.
	\end{itemize}
	\vspace{5 pt}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item Trained and evaluated LLMs for the \textbf{Lean 4} proof assistant for end-to-end formal verification, aligned with AWS automated reasoning initiatives.
	\end{itemize}
	\vspace{5 pt}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item Co-built \textit{Morph Prover v0-7B} (first openly released Lean 4 frontier model) and led the embedding system behind \textit{Moogle.ai} for verified Lean-code retrieval and premise selection.
	\end{itemize}
	\vspace{5 pt}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item Consulted on AI-agent systems for sales performance (company featured in Forbes Mexico).
	\end{itemize}
	\vspace{5 pt}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item Studied Transformer prediction of formal mathematical proofs in the Coq theorem-proving language.
	\end{itemize}
	\vspace{5 pt}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item Ph.D. with Prof. Sanmi Koyejo on meta-learning and cognitively inspired deep learning for program synthesis, theorem proving, and reasoning.
	\end{itemize}
	\vspace{5 pt}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item Deep learning theory research with Prof. Tomaso Poggio; thesis on training methods for Deep Gaussian Networks and function approximation for compositional hierarchical functions. \href{https://cbmm.mit.edu/about/people/miranda}{[CBMM page]}
	\end{itemize}
	\vspace{5 pt}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item Mentor at Stanford (Foundation Model data quality), UIUC REU programs, and the MIT CBMM Engineering of Intelligence Team \href{https://cbmm.mit.edu/eit/people}{(EIT)}.
	\end{itemize}
	\vspace{5 pt}
