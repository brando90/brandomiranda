...
\begin{body}
    ...
    \textbf{International Conference on Learning Representations (ICLR) 2024} \& \textbf{NeurIPS Red Teaming GenAI Workshop Contributed Talk 2024}\\
...
\begin{body}
	...
	\begin{itemize} \itemsep -2pt  % reduce space between items
		\item Ph.D. research with Prof. Sanmi Koyejo on \textbf{AI for formal mathematics and Lean 4}: benchmarks, tooling, and training methods for autoformalization, theorem proving, and end-to-end formal verification of AI-generated code
		\item Lead/co-lead on four Lean 4 artifacts: \textit{Putnam-AXIOM} (functional/static Putnam-level math reasoning, ICML 2025), \textit{VeriBench} (end-to-end Lean 4 formal verification, 2nd AI for Math Workshop @ ICML 2025), \textit{Pantograph} (machine-to-machine Lean 4 interface, TACAS 2025), and an autoformalization benchmark for Lean 4 (ICLR 2024 Tiny Papers Track)
		...
		\item Published award-winning work challenging prevailing notions of ``emergent abilities'' in large language models (NeurIPS Outstanding Paper Award 2023); data-centric ML work (\textit{Beyond Scale} diversity coefficient; contamination quantification) directly informs Lean autoformalization corpus design and benchmark integrity
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item Trained and evaluated LLMs for the \textbf{Lean 4} Proof Assistant and Programming Language for end-to-end formal verification
	\end{itemize}
	\vspace{5 pt}
