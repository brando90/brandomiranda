...
\begin{body}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
		\item Ph.D. with Prof. Sanmi Koyejo on meta-learning, transfer learning, and data diversity for program synthesis and reasoning.
	\end{itemize}
	\vspace{5 pt}
	...
	\vspace*{-3pt}
	\begin{itemize} \itemsep -2pt
        \item Deep learning theory research with Prof. Tomaso Poggio (who also mentored DeepMind co-founder Demis Hassabis); contributed to highly-cited work on generalization theory and function approximation for neural networks.
	\end{itemize}
