...
\begin{body}
	\vspace{14pt}
	AI for formal mathematics and Lean 4 theorem proving --- autoformalization, end-to-end formal verification of AI-generated code, and contamination-resistant evaluation of LLM mathematical reasoning. Lead/co-lead on Lean 4 benchmarks and tools: \textit{Putnam-AXIOM} (ICML 2025), \textit{VeriBench} (2nd AI for Math Workshop @ ICML 2025), \textit{Pantograph} (TACAS 2025), and an autoformalization benchmark (ICLR 2024 Tiny Papers Track). Also contributed to \textit{Morph Prover v0-7B} (first frontier Lean 4 model) and \textit{Moogle.ai} (Lean-code retrieval/search system). Adjacent data-centric ML work --- NeurIPS Outstanding Paper on the ``emergent-abilities mirage'' and the \textit{Beyond Scale} diversity coefficient --- directly informs corpus design and contamination-resistant evaluation for AI mathematics.
\end{body}
