...
In mathematics, the act of checking has a structure we don't always take advantage of. A proof of Fermat's Last Theorem is long, intricate, and beyond most of us to audit line by line. But the *statement* of Fermat's Last Theorem is short. If the theorem is written in [Lean](https://lean-lang.org), the kernel checks the proof automatically and deterministically. What a human actually has to verify is not the hundreds of pages of argument but a single claim: that the Lean statement faithfully expresses the informal theorem.
...
And here's what's new: in this era of AI agents, formal methods are within practical reach in a way they weren't five years ago, and Lean specifically is the tool. There is no comparable alternative, and the momentum is unambiguous. AWS verifies its [Cedar](https://www.amazon.science/blog/how-we-built-cedar-with-automated-reasoning-and-differential-testing) authorization language in Lean. DeepMind's [AlphaProof](https://deepmind.google/blog/ai-solves-imo-problems-at-silver-medal-level/) reached IMO silver-medal performance proving theorems in Lean ([*Nature*, 2025](https://www.nature.com/articles/s41586-025-09833-y)). [Harmonic](https://harmonic.fun) and [Axiom](https://axiommath.ai) were both founded with Lean as their backbone. The community library [Mathlib](https://leanprover-community.github.io/) is past 1.6M lines and includes the formal verification of Tao's [Polynomial Freiman–Ruzsa Conjecture](https://terrytao.wordpress.com/2023/11/18/formalizing-the-proof-of-pfr-in-lean4-using-blueprint-a-short-tour/) and parts of Scholze's [Liquid Tensor Experiment](https://leanprover-community.github.io/blog/posts/lte-final/). Coordinating this ecosystem is the non-profit [Lean FRO](https://lean-lang.org/fro/about/), which is fighting to stay funded; if you care about trustworthy software and AI, it is worth supporting. What used to be a niche enterprise for a handful of specialists is starting to look like a workflow the rest of us can adopt, which is exactly why scalable oversight through formal methods is a live question now and wasn't five years ago.
...
@misc{miranda2026formaloversight,
  ...
  year   = {2026},
  month  = {April},
  howpublished = {\url{https://cs.stanford.edu/people/brando9/2026/04/22/formal-methods-scalable-oversight.html}},
  note   = {Blog post}
}
```
