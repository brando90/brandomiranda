...
And here's what's new: in this era of AI agents, proofs and formal methods feel closer to practical reach than they ever have. Autoformalization is actually improving. Proof search assisted by language models is usable, not just a demo. Tooling around verification is scaling. What used to be a niche enterprise for a handful of specialists is starting to look like a workflow the rest of us can adopt — which is exactly why scalable oversight through formal methods is a live question now and wasn't five years ago.
