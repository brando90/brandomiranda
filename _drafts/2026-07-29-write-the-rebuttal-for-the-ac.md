...
These are working heuristics from one reviewing cycle, the NeurIPS 2026 Position Paper Track, incorporating advisor and co-author feedback. Some of it is mechanics of how the process works. Some of it is my opinion, and I'll flag which is which.

## The AC is the reader who matters

Reviewer scores rarely move. You can answer a weakness cleanly, get an acknowledgement that the concern is addressed, and see the score sit exactly where it was. A reviewer has already committed a position to the record, and updating it costs them something.

The area chair sits differently. They have to produce a decision from the whole record: every review, every response, whatever discussion happened, and their own read of the paper. They're the only person who sees all of it at once.

Two things follow. First, answer the metareview before you're tired. If the AC flagged three concerns, address those three first and in the AC's order. Second, consistency across threads stops being good manners and becomes load-bearing. Tell one reviewer the effect is small and another that it's clear, and the AC is the reader who notices.

## Then triage by score

After the metareview, go lowest first, then the middling ones. Leave a strong accept mostly alone.

The reasoning is about what the AC is looking at. Uniform accepts make the AC's job easier; one strong accept next to a reject does not. A single low score forces the AC to justify the outcome, and you want that justification to be easy to write.

Under-discussed corollary: a strong accept is a thing you can lose, and pushing back isn't how you lose it. Concede too thoroughly across the response and the reviewer re-reads their own score, wondering whether they were generous. Watch your concession density on the reviews that already like you.
...
Before you accept a technical premise, check it. Reviewer premises can just be wrong. A review may call one method a "weaker baseline" when the two methods are the same algorithm under different names. Conceding that premise would put a false statement in writing where the AC can read it.

Here's a case worth naming because it's easy to misread as an attack. A reviewer says your effect might be explained by some other property you didn't measure. If your paper's position is that this property should be measured and reported, the reviewer has just made your argument for you. Credit the point, agree, and say what it implies for practice. An alternative explanation nobody currently reports is evidence *for* a reporting position.

When the honest answer is somewhere in the middle, refine, don't retreat. "A clear change in observed behaviour, small in magnitude" is a sentence you can defend. "We withdraw the claim" gives away more than the evidence requires.
...
Related, and worth checking line by line: don't volunteer self-criticism harsher than the reviewer's own framing. If they wrote that two constructs are "connected but not the same," treat it as a precision request. Nothing more. Cut the intensifiers while you're in there. "Outright," "entirely," "completely," "we were wrong" all cost you something and buy nothing. The unmodified verb is stronger.

Don't point at your worst weakness either. Telling a reviewer "this is the sharpest gap in the paper" only helps them find it. They already scored the paper. They don't need the help.
...
Prefer facts already in the submitted PDF to anything you generate during the rebuttal window. The best answers are often already sitting in your own appendix tables. Pointing at Table 7 is stronger than running something new.

If you do run something new, label it honestly. Present a post hoc comparison as a sensitivity check rather than as a controlled experiment. State n. If your evidence is that three conditions came out in the predicted order, say that the predicted ordering of three comes up one time in six by chance. Better you say it than them.

Keep association and causation apart, and when you only have association, name the design that would identify the causal claim.
...
- **Don't cite your own adjacent unpublished or parallel paper.** It compromises double-blind review, and it invites a thin-slicing critique: why is this two papers if the load-bearing evidence lives in the other one? Eat the scope gap.

## Construction

Answer the question actually asked, not the adjacent one you'd rather answer. "What's the consequence for an experimentalist?" wants concrete actions. Explaining the mechanism again is a non-answer.
...
When a reviewer hands you a good framing and asks you to make it explicit: take it, credit them in a clause, and add something of your own. Pure echo is a thank-you note.
...
- The recurring frames: "not X, but Y", "It is worth noting that", "This is precisely why", "We would like to emphasise", "Importantly", "Furthermore", "delve", "leverage", "robust" as filler, "crucially".
...
Then read it aloud. That catches more than any checklist, this one included.
...
Then the mechanical pass: strip the LaTeX escaping, convert to markdown, check headers sit on their own line, check the character count, confirm nothing got truncated.

## What I'm less sure about

One cycle, one track, one paper. Treat the specifics accordingly.

The claim I'd defend hardest is that the AC is the audience. The claim I'd defend least is the concession-density one, about losing a strong accept by over-conceding. I believe it, and one cycle cannot establish it. Venues differ too, and my guess is that how closely an AC reads the responses differs with them. You can't tell which kind you have until it's over.
