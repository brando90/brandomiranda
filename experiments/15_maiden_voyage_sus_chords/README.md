...
- Long cut (everything trimmed out of the post, verbatim): [Google Doc](https://docs.google.com/document/d/1HeSoG6DYnvrnemRD0O1ZnAXnb8aeqCgwsTQAAk0gRs8/edit) — private to Brando's account, deliberately not linked from the published post.
